...
/**
Token: SIGMA INU
Website: https://sigmainu.com
Telegram: https://t.me/sigmainu
Twitter: https://twitter.com/sigmainu
**/
...
contract SIGMAINU is ERC20, Ownable {
    ...
    uint256 public swapTokensAtAmount = 1 * 10**3 * (10**9); 

    uint256 public maxBuyAmount = 2 * 10**7 * 10**9; // 1% of the supply
    uint256 public maxSellAmount = 1 * 10**7 * 10**9; // 1% of the supply
    uint256 public maxWalletAmount = 2 * 10**7 * 10**9; // 5% of the supply
    ...
    address payable _marketingWallet = payable(address(0x8691aB0F23A7B82AE7E7bFc148C1E83f4E06a689)); // MarketingWallet
    ...
    constructor() ERC20("Sigma Inu", "SIGMA") {

        buyFee.marketingFee = 9;
        
        buyFee.liquidityFee = 1;
        
        totalBuyFee = 10;

        sellFee.marketingFee = 11;
        ...
        */
        _mint(owner(), 1 * 10**9 * (10**9)); //  1 QuadTrillion Tokens
    }
   ...
   function setBuyFee(
        ...
        buyFee.marketingFee = marketingfee;
        buyFee.liquidityFee = liquidity;
        totalBuyFee = marketingfee + liquidity;
    }
    ...
    function setSellFee(
        ...
        sellFee.marketingFee = marketingfee;
        sellFee.liquidityFee = liquidity;
        totalSellFee = marketingfee + liquidity;
    }
   ...
   function setSwapTokensAtAmount(uint256 amount) external onlyOwner {
    ...
    function swapAndSendMarketing(uint256 tokens) private lockTheSwap {
